  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_ROOT}/Customers/register.php`,
        {
          method: "POST",
      ...
      // API may return customer directly
      // or inside data.customer.
      const customer =
        result.customer ||
      ...
      if (!customer?.id) {
        throw new Error(
          "Customer account was created, but customer information was not returned."
        );
      }
